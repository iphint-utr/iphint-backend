...
export interface ISubscription extends Document {
  ...
  pendingPlanTier?: 'starter' | 'pro' | 'premium';
...
const SubscriptionSchema = new Schema<ISubscription>(
  {
    ...
    pendingPlanTier:      { type: String, enum: ['starter', 'pro', 'premium'] },
    pendingBillingCycle:  { type: String, enum: ['monthly', 'annual'] },
    pendingChangeEffectiveAt: { type: Date },
  },
  { timestamps: true },
);
